...
//ol.proj.get("EPSG:3857").setExtent([-5504093.116300, 834753.707199, 3152421.382042, 6866522.430182]);
var wms_layers = [];
...
lyr_Structures_1.set('fieldLabels', {'fid': 'no label', 'Structures': 'header label - visible with data', 'Infos': 'header label - visible with data', });
